...
Data[Data.length++]=new SForm("form_TaiPing","Get","http://ks.pconline.com.cn/index.jsp?q=","太平洋","web","false");
...
Data[Data.length++]=new SForm("form_XunLei","Get","http://so.xunlei.com/search?search=","迅雷","download","false");
Data[Data.length++]=new SForm("form_bt_china","Get","http://search.btchina.net/btsearch.php?query=","BT@China","download","false");
Data[Data.length++]=new SForm("form_bt_fkee","Get","http://bt.fkee.com/search.aspx?q=","飞客","download","false");
...
Data[Data.length++]=new SForm("form_baidu_music","Get","http://mp3.baidu.com/m?f=ms&tn=baidump3&ct=134217728&lf=&rn=&lm=-1&word=","百度","music","false");
Data[Data.length++]=new SForm("form_yahoo_music","Get","http://music.yahoo.com.cn/search?p=","Yahoo","music","false");
Data[Data.length++]=new SForm("form_SouGou_Music","Get","http://d.sogou.com/music.so?query=","搜狗","music","false");
...
Data[Data.length++]=new SForm("form_BT_IT","Get","http://bt.it.com.cn/search.asp?key=","BT全球搜索","download","false");
...
Data[Data.length++]=new SForm("form_Tianwang","Get","http://www.tianwang.com/cgi-bin/tw?range=0&cd=03&word=","天网资源搜索","download","false");
Data[Data.length++]=new SForm("form_kuaiche","Get","http://se.kuaiche.com/search?k=","快车全球资源","download","false");
Data[Data.length++]=new SForm("form_edugo","Get","http://www.edugo.cn/Search.asp?SearchKey=","EDUGO教育资源搜索","download","false");
